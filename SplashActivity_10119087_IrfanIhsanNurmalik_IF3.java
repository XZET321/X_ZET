...
public class SplashActivity_10119087_IrfanIhsanNurmalik_IF3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            ...
            public void run() {
                ...
                startActivity(new Intent(SplashActivity_10119087_IrfanIhsanNurmalik_IF3.this, MainActivity_10119087_IrfanIhsanNurmalik_IF3.class));
                finish();
            }
        }, SPLASH_TIME_OUT);
    }
